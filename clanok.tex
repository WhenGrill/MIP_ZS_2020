...
V nasledujúcich podsekciách si rozoberieme výhody a nevýhody dištančného vzdelávania\cite{Sokolova2018}. Každý systém má svoje výhody ale aj nevýhody. Dištančné vzdelávanie nesie zo sebou veľa pozitívnych aspektov, ktoré pomahajú nie len študentom, ale aj učiteľom a univerzitám. Avšak dištančné vzdelávanie nesie zo sebou aj isté negatíva ako napríklad formu testovania, komunikácia a interakcia študentov z učiteľmi a podobne. 
\subsection{Výhody}
\begin{itemize}
