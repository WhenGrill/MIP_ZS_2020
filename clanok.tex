...
Na margo uzatvárania škôl z dôvodu celosvetovej pandémie COVID-19 boli školy nútené prejsť na dištančné vzdelávanie. Dištančné vzdelávanie so sebou berie isté pre ale aj proti. Vo výskume boli účastníkmi zodpovedné otázky ako boli spokojní s výučbou a či mali potiaže s prechodom.
Výskum ukazuje že iba malé percento opýtaných malo isté tažkosti s prechodom na dištančnú formu výučby. V rámci výskumu je možno vidieť aj najčastejšie používané on-line platformy pre dištančné vzdelávanie.
